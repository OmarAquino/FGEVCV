...
function buscarNombreJur($nombre,$apat,$amat){
	...
	if ($nombre !="" and $apat!="" and $amat=="") :
		$query="SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[nombre] LIKE '%$nombre%' AND [personas].[a_paterno] LIKE '%$apat%' ORDER BY [personas].[id_per]";
		//nombre y apellidos
	elseif ($nombre!="" and $apat!="" and $amat!="") :
		$query = "SELECT distinct distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[nombre] LIKE '%$nombre%' AND [personas].[a_paterno] LIKE '%$apat%' AND [personas].[a_materno] LIKE '%$amat%' ORDER BY [personas].[id_per]";
	//Apellidos
	elseif ($nombre=="" and $apat!="" and $amat!="") :
		$query="SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[a_paterno] LIKE '%$apat%' AND [personas].[a_materno] LIKE '%$amat%' ORDER BY [personas].[id_per]";
		//Nombre
	elseif ($nombre!="" and $apat=="" and $amat=="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[nombre] LIKE '%$nombre%' ORDER BY [personas].[id_per]";
		//Paterno
	elseif ($nombre=="" and $apat!="" and $amat=="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[a_paterno] LIKE '%$apat%' ORDER BY [personas].[id_per]";
		//Materno
	elseif ($nombre=="" and $apat=="" and $amat!="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[a_materno] LIKE '%$amat%' ORDER BY [personas].[id_per]";
		//Nombre y Materno
	elseif ($nombre !="" and $apat=="" and $amat!="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[nombre] LIKE '%$nombre%' AND [personas].[a_materno] LIKE '%$amat%' ORDER BY [personas].[id_per]";
	endif;
	$result = sqlsrv_query($con, $query);
	if (sqlsrv_has_rows($result)!=0) {
			while($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
...
function buscarPaginacionJur($nombre,$apat,$amat,$offset,$limit){
	include('db.php');//nombre y apellido pat
	if ($nombre !="" and $apat!="" and $amat=="") :
		$query="SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[nombre] LIKE '%$nombre%' AND [personas].[a_paterno] LIKE '%$apat%' ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
		//nombre y apellidos
	elseif ($nombre!="" and $apat!="" and $amat!="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[nombre] LIKE '%$nombre%' AND [personas].[a_paterno] LIKE '%$apat%' AND [personas].[a_materno] LIKE '%$amat%' ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
	//Apellidos
	elseif ($nombre=="" and $apat!="" and $amat!="") :
		...
		//Nombre
	elseif ($nombre!="" and $apat=="" and $amat=="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[nombre] LIKE '%$nombre%' ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
		//Paterno
	elseif ($nombre=="" and $apat!="" and $amat=="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[a_paterno] LIKE '%$apat%' ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
		//Materno
	elseif ($nombre=="" and $apat=="" and $amat!="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 1 AND [personas].[a_materno] LIKE '%$amat%' ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
		//Nombre y Materno
...
function buscarNombre($nombre,$apat,$amat){
	include('db.php');//nombre y apellido pat
	if ($nombre !="" and $apat!="" and $amat=="") :
		$query="SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas] inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per] inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per] inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[nombre] LIKE '%$nombre%' AND [personas].[a_paterno] LIKE '%$apat%' ORDER BY [personas].[id_per]";
		//nombre y apellidos
	elseif ($nombre!="" and $apat!="" and $amat!="") :
	$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[nombre] LIKE '%$nombre%'  AND [personas].[a_paterno] LIKE '%$apat%' AND [personas].[a_materno] LIKE '%$amat%'  ORDER BY [personas].[id_per]";
	//Apellidos
	elseif ($nombre=="" and $apat!="" and $amat!="") :
		$query="SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[a_paterno] LIKE '%$apat%' AND [personas].[a_materno] LIKE '%$amat%'  ORDER BY [personas].[id_per]";
		//Nombre
	elseif ($nombre!="" and $apat=="" and $amat=="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[nombre] LIKE '%$nombre%'  ORDER BY [personas].[id_per]";
		//Paterno
	elseif ($nombre=="" and $apat!="" and $amat=="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[a_paterno] LIKE '%$apat%'  ORDER BY [personas].[id_per]";
		//Materno
	elseif ($nombre=="" and $apat=="" and $amat!="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[a_materno] LIKE '%$amat%'  ORDER BY [personas].[id_per]";
		//Nombre y Materno
	elseif ($nombre !="" and $apat=="" and $amat!="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[nombre] LIKE '%$nombre%'  AND [personas].[a_materno] LIKE '%$amat%'  ORDER BY [personas].[id_per]";
	endif;
	$result = sqlsrv_query($con, $query);
	if (sqlsrv_has_rows($result)!=0) {
			while($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
...
function buscarPaginacion($nombre,$apat,$amat,$offset,$limit){
	include('db.php');//nombre y apellido pat
	if ($nombre !="" and $apat!="" and $amat=="") :
		$query="SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc]  AND [concesiones].[ind_pre] = 0 AND [personas].[nombre] LIKE '%$nombre%' AND [personas].[a_paterno] LIKE '%$apat%' ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
		//nombre y apellidos
	elseif ($nombre!="" and $apat!="" and $amat!="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[nombre] LIKE '%$nombre%'  AND [personas].[a_paterno] LIKE '%$apat%' AND [personas].[a_materno] LIKE '%$amat%' ORDER BY [personas].[id_per]  OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
	//Apellidos
	elseif ($nombre=="" and $apat!="" and $amat!="") :
		...
		//Nombre
	elseif ($nombre!="" and $apat=="" and $amat=="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[nombre] LIKE '%$nombre%'  ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
		//Paterno
	elseif ($nombre=="" and $apat!="" and $amat=="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[a_paterno] LIKE '%$apat%'  ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
		//Materno
	elseif ($nombre=="" and $apat=="" and $amat!="") :
		$query = "SELECT distinct [personas].[id_per], [personas].[nombre], [personas].[a_paterno], [personas].[a_materno], [concesiones].[id_conc], [concesiones].[placa], [concesiones].[num_economico] FROM [SistBusquedas].[dbo].[personas]  inner join [SistBusquedas].[dbo].[per_carp] on [personas].[id_per] = [per_carp].[id_per]  inner join [SistBusquedas].[dbo].[per_conc] on [per_carp].[id_per] = [per_conc].[id_per]  inner join [SistBusquedas].[dbo].[concesiones] on [concesiones].[id_conc] = [per_conc].[id_conc] AND [concesiones].[ind_pre] = 0 AND [personas].[a_materno] LIKE '%$amat%'  ORDER BY [personas].[id_per] OFFSET $offset ROWS FETCH NEXT $limit ROWS ONLY";
		//Nombre y Materno
